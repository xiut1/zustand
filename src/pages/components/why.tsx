  ...
  return (
    <div className="wrap">
      <div className="box">
        ...
        <ul>
          <li>
            <strong className="underline">컴포넌트간 공유</strong>
            <br />
      ...
      <div className="box">
        ...
        <ul>
          <li>
            <strong className="underline">Context</strong>는 전역 상태를
            저장하는 곳이다. <br />
            Context 내부에 Provider와 Consumer가 정의되어있고, Consumer는
            Context를 통해서 상태에 접근이 가능하다.
          </li>
          <li>
            <strong className="underline">Provider</strong>는 전역 상태를
            제공하는 역할을 한다. <br />
          ...
          <li>
            <strong className="underline">Consumer</strong>는 제공받은 전역
            상태를 받아서 사용하는 역할을 한다.
          </li>
        </ul>
        <p>
        ...
        <ul>
          <li>
            <strong className="underline">Store</strong>는 컴포넌트와 별개로
            스토어라는 폴더 내에서, 프로젝트내에서 필요한 상태를 담는다.
            컴포넌트에서 상태 정보가 필요할 때 스토어에 접근한다.
          </li>
          <li>
            <strong className="underline">Action</strong>은 앱에서 스토어에
            운반할 데이터를 말한다. Action은 자바스크립트 객체 형식으로 되어
            있다.
          </li>
          <li>
            <strong className="underline">Reducer</strong>는 Action을 수신 한 후
            새로운 상태를 생성하는 함수이다.
          </li>
        </ul>
        <p>
